...
// Implementing the Verlet algorithm
// Computes new positions and velocities for a body
// in discrete timesteps using Newtonian forces
double verlet()
{

	/*----------------To set Mercury initial values: uncomment the next two lines------*/
...
//	dt = 10000; 																//adjustable if preferred
	...
	// To decrease sun's mass: uncomment next line
		...
		// Update planet velocities as per the Verlet Algorithm
		for(i = 0; i <= planet_count; i++)
		{
